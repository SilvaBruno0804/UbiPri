...
$bdAmbiente = $ambienteCtrl->retorneLinhaEspecificaBaseDadosTipoAmbiente($url->getURL(5));
    ...
    <div id="conteudo">
        ...
        <div class="ui segment">
            <div class="navigation">
                <nav class="ui breadcrumb">
                    ...
                    <i class="right arrow icon divider"></i>
                    <div class="active section">Editar Tipo de Ambiente</div>
                </nav>
            </div>
        </div>
        <!--Navegação-->
        ...
        <div class="ui yellow segment">
            ...
            <div class='ui icon message'>
                <div class='content' >
                    <h4 class="ui dividing header">Editar Tipo Ambiente</h4>
                    ...
                    <form action="<?php echo(VIEW."ambiente/tipo-ambiente/services-tipo-ambiente.php")?>"  class="ui form" name="form-tipo-ambiente" id="form-tipo-ambiente" method="post">
                        ...
                        <input type="hidden" id="form" name="form" value="editar-tipo-ambiente" />
                        <input type="hidden" id="tipo-ambiente-id" name="tipo-ambiente-id" value="<?php echo($url->getURL(5))?>" />
                        ...
                        <div class="required fields ">
                            <div class="sixteen wide field">
                                ...
                                <input type="text" name="nome" id="nome" placeholder="Nome do Tipo do Ambiente" tabindex="1" value="<?php echo($bdAmbiente[0]->nome)?>"  />
                            </div>
                        </div>
                        <!--Nome do Ambiente-->
                        ...
                        <div class="fields ">
                            <div class="sixteen wide field">
                                ...
                                <textarea id="obs" name="obs" tabindex="2" rows="2" ><?php echo($bdAmbiente[0]->obs)?></textarea>
                            </div>
                        </div>
                        <!--Observação-->
                    ...
                    <div class="center aligned">
                        <div class="ui buttons">
                            ...
                            <button class="ui right labeled icon orange button submit" id="btn-submit" form="form-tipo-ambiente">Salvar Alterações<i class="save icon"></i></button>
                        </div>
                    </div>
