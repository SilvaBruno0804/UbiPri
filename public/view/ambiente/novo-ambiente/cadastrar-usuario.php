            ...
            <div class='ui icon message'>
                <div class='content' >
                    ...
                    <form action="<?php echo(VIEW."ambiente/novo-ambiente/services-ambiente.php")?>"  class="ui form" name="form-cadastrar-usuario-ambiente" id="form-cadastrar-usuario-ambiente" method="post">
                        ...
                        <input type="hidden" id="form" name="form" value="cadastrar-usuario-ambiente" />
                        ...
                        <div class="required fields ">
                            ...
                            <div class="required two wide field">
                                ...
                                <input type="text" name="Usuario_id" id="Usuario_id"  value="" readonly  />
                            </div>
                            <!--Codigo do Usuário-->
                            ...
                            <div class="required four wide field">
                                ...
                                <input type="text" name="pes_email" id="pes_email"  value="" readonly  />
                            </div>
                            <!--Codigo do Usuário-->
                        ...
                        <div class="required fields ">
                            ...
                            <div class="ten wide field">
                                ...
                                <div class="ui fluid search multiple  selection dropdown">
                                    <input type="hidden" id="dias_semana" name="dias_semana"  tabindex="2" value="" >
                            ...
                            <div class="required two wide field">
                                ...
                                <input type="text" name="hora_inicio" id="hora_inicio" class="hour" placeholder="00:00" tabindex="3" value=""  />
                            </div>
                            <!--Hora Inicio-->
                            ...
                            <div class="required two wide field">
                                ...
                                <input type="text" name="hora_fim" id="hora_fim" class="hour" placeholder="00:00"  tabindex="4" value=""  />
                            </div>
                            <!--Hora Inicio-->
                        ...
                        <div class="fields ">
                            <div class="sixteen wide field">
                                ...
                                <textarea id="pessoa_ambiente_obs" name="pessoa_ambiente_obs" tabindex="5" rows="2" ></textarea>
                            </div>
                        </div>
                        <!--Observação-->
