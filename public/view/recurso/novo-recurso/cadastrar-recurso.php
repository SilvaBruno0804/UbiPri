    ...
    <div id="conteudo">
        ...
        <div class="ui segment">
            <div class="navigation">
                <nav class="ui breadcrumb">
                    ...
                    <i class="right arrow icon divider"></i>
                    <div class="active section">Cadastrar Novo Recurso</div>
                </nav>
            </div>
        </div>
        <!--Navegação-->
        ...
        <div class="ui yellow segment">
            ...
            <div class='ui icon message'>
                <div class='content' >
                    <h4 class="ui dividing header">Cadastrar Novo Recurso</h4>
                    ...
                    <form action="<?php echo(VIEW."recurso/novo-recurso/services-recurso.php")?>"  class="ui form" name="form-novo-recurso" id="form-novo-recurso" method="post">
                        ...
                        <input type="hidden" id="form" name="form" value="cadastrar-novo-recurso" />
                        ...
                        <div class=" fields ">
                            ...
                            <div class="required eight wide field">
                                ...
                                <input type="text" name="recurso_nome" id="nome" placeholder="recurso_nome" tabindex="1" value=""  />
                            </div>
                            <!--Nome do Ambiente-->
                            ...
                            <div class="required eight wide  field">
                                ...
                                <div class="ui fluid search selection dropdown">
                                    <input type="hidden" id="Ambiente_id" name="Ambiente_id"  tabindex="2" value="" >
                        ...
                        <div class="fields ">
                            <div class="sixteen wide field">
                                ...
                                <textarea id="recurso_obs" name="recurso_obs" tabindex="3" rows="2" ></textarea>
                            </div>
                        </div>
                        <!--Observação-->
